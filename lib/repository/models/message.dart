...
class Message {
  ...
  factory Message.fromMap(Map<String, dynamic> json) {
    return new Message(
      ...
      error: (json["error"] is bool) ? json['error'] : ((json['error'] == 1) ? true : false),
      ...
      isSystemMessage: (json["isSystemMessage"] is bool) ? json['isSystemMessage'] : ((json['isSystemMessage'] == 1) ? true : false),
      isServiceMessage: (json["isServiceMessage"] is bool) ? json['isServiceMessage'] : ((json['isServiceMessage'] == 1) ? true : false),
      ...
      isAudioMessage: (json["isAudioMessage"] is bool) ? json['isAudioMessage'] : ((json['isAudioMessage'] == 1) ? true : false),
      ...
      associatedMessageGuid: json.containsKey("associatedMessageGuid") ? json["associatedMessageGuid"] : null,
      ...
      timeExpressiveSendStyleId: json.containsKey("timeExpressiveSendStyleId") ? parseDate(json["timeExpressiveSendStyleId"]) : null,
      from: json.containsKey("from") ? (json['from'] != null ? Handle.fromMap(json['from']) : null) : null,
      hasAttachments: json.containsKey("attachments") ? (((json['attachments'] as List<dynamic>).length > 0) ? true : false) : false
    );
  }
  ...
  static Future<List<Attachment>> getAttachments(Message message) async {
    ...
    var res = await db.rawQuery("SELECT"
        ...
        " attachment.transerState AS transferState,"
        ...
        " JOIN attachment ON attachment.ROWID = cmj.attachmentId"
        " WHERE message.ROWID = ?;",
        [message.id]
    );
  ...
  static Future<List<Message>> find([Map<String, dynamic> filters = const{}]) async {
    ...
    var res = await db.query(
      "message", where: (whereParams.length > 0) ? whereParams.join(" AND ") : null , whereArgs: (whereArgs.length > 0) ? whereArgs : null);
  ...
  Map<String, dynamic> toMap() => {
    ...
    "timeExpressiveSendStyleId": (timeExpressiveSendStyleId == null) ? null : timeExpressiveSendStyleId.millisecondsSinceEpoch,
