...
/// primitives, following `material_chat_options.dart` as the reference
/// implementation. No pull-to-refresh and no manual refresh button, on any
/// skin — the page only ever re-analyzes on the initial "Analyze" tap, on a
/// filter change, or automatically after a delete (to verify it landed).
class MaterialStorageAnalyzerPanel extends StatelessWidget with StorageAnalyzerHelpersMixin {
  const MaterialStorageAnalyzerPanel({super.key, required this.controller});
