...
- Resolves the quoted part via `MessageState.partById` (message-part id, not list index). A miss does **not** fall back to another part — iOS shows an error bubble; tap is a no-op.
