...
class ApiService extends GetxService {
  ...
  Future<Response> chatParticipant(String method, String guid, String address, {CancelToken? cancelToken}) async {
    return await dio.post("$origin/chat/$guid/participant/$method",
  ...
  Future<Response> updateChat(String guid, String displayName, {CancelToken? cancelToken}) async {
    return await dio.put("$origin/chat/$guid",
  ...
  Future<Response> createChat(List<String> addresses, String? message, {CancelToken? cancelToken}) async {
    return await dio.post("$origin/chat/new",
  ...
  /// body of the message.
  Future<Response> sendAttachment(String chatGuid, String tempGuid, File file,
    ...
    return await dio.post("$origin/message/attachment",
        queryParameters: buildQueryParams(), cancelToken: cancelToken, data: formData, onSendProgress: onSendProgress);
  }
  ...
  Future<Response> sendTapback(String chatGuid, String selectedMessageText, String selectedMessageGuid, String reaction,
      {CancelToken? cancelToken}) async {
    return await dio.post("$origin/message/react",
        queryParameters: buildQueryParams(),
        data: {
          "chatGuid": chatGuid,
