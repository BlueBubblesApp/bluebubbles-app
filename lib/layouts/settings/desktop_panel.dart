                            ...
                            child: Column(
                              ...
                              children: <Widget>[
                                SettingsTile(
                                  title: "Actions",
                                  subtitle:
                                      "Click on actions to toggle them. Drag actions to reorder them. You can select up to 5 actions.",
                                ),
                                Padding(
                                                  ...
                                                  return Positioned(
                                                    ...
                                                    child: Container(
                                                      ...
                                                      decoration: BoxDecoration(
                                                        ...
                                                        border: Border.all(
                                                            color:
                                                                context.textTheme.bodyText1!.color!.withOpacity(0.1)),
                                      ...
                                      if (showMarkRead)
                                        Positioned(
                                          ...
                                          child: Container(
                                            ...
                                            width: size * 0.92 - 0.5,
                                            padding:
                                                EdgeInsets.symmetric(vertical: size * 0.01, horizontal: size * 0.02),
                                            decoration: BoxDecoration(
                                              borderRadius: BorderRadius.circular(5),
                                              border: Border.all(
                                            ...
                                            child: Center(
                                              child: Text(
                                                "Mark Read",
                                                style: context.textTheme.bodyText1!.copyWith(fontSize: size * 0.037),
                                                textAlign: TextAlign.center,
                                              ),
                                            ),
                                          ),
