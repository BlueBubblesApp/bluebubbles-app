                                ...
                                children: [
                                  ElevatedButton(
                                    ...
                                    onPressed: () async {
                                      ...
                                      String name =
                                          "Android_${now.year}${now.month}${now.day}_${now.hour}${now.minute}${now.second}";
                                                            ...
                                                            itemBuilder: (context, index) {
                                                              return ListTile(
                                                                ...
                                                                onTap: () async {
                                                                  ...
                                                                  Get.back();
                                                                  showSnackbar(
                                                                      "Success", "Theming restored successfully");
                                                                },
                                                              );
                                                            },
                                                          ),
                                      ...
                                      onPressed: () async {
                                        ...
                                        showSnackbar(
                                          ...
                                          button: TextButton(
                                            ...
                                            child:
                                                Text("SHARE", style: TextStyle(color: Theme.of(context).primaryColor)),
                                          ),
                                        );
                                      },
                                      child: Text(
                        ...
                        SettingsTile(
                          ...
                          onTap: () async {
                            ...
                            ContactManager()
                              ...
                              if (index !=
                                  ContactManager().handleToContact.values.where((element) => element != null).length -
                                      1) {
                                json = json + ",";
                              } else {
                                json = json + "]";
                            ...
                            SocketManager().sendMessage("save-vcf", {"vcf": json},
                                (_) => showSnackbar("Notice", "Successfully exported contacts to server"));
                          },
                          leading: SettingsLeadingIcon(
