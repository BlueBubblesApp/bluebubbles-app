                  ...
                  if (_settingsCopy.enableQuickTapback)
                    SettingsOptions<String>(
                      ...
                      cupertinoCustomWidgets: [
                        Reaction(reactionType: ReactionTypes.LIKE).getSmallWidget(context, message: Message(isFromMe: true), leftPadding: false)!,
                        Reaction(reactionType: ReactionTypes.LOVE).getSmallWidget(context, message: Message(isFromMe: true), leftPadding: false)!,
                        Reaction(reactionType: ReactionTypes.DISLIKE).getSmallWidget(context, message: Message(isFromMe: true), leftPadding: false)!,
                        Reaction(reactionType: ReactionTypes.QUESTION).getSmallWidget(context, message: Message(isFromMe: true), leftPadding: false)!,
                        Reaction(reactionType: ReactionTypes.EMPHASIZE).getSmallWidget(context, message: Message(isFromMe: true), leftPadding: false)!,
                        Reaction(reactionType: ReactionTypes.LAUGH).getSmallWidget(context, message: Message(isFromMe: true), leftPadding: false)!,
                      ],
