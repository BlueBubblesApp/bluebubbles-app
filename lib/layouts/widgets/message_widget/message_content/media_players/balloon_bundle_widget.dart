                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    Text("Interactive Message",
                        textAlign: TextAlign.center, maxLines: 1, style: Theme.of(context).textTheme.labelLarge),
                    Container(height: 10.0),
                    Icon(bundleIcon, color: Theme.of(context).textTheme.bodyMedium!.color, size: 48),
                    Container(height: 10.0),
                    Text("(Cannot open on Android)",
                        textAlign: TextAlign.center, maxLines: 1, style: Theme.of(context).textTheme.labelMedium),
                  ],
                ),
              ),
            )),
