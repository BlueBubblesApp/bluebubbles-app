...
class BlueBubblesTextFieldState extends State<BlueBubblesTextField> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    controller.addListener(() {
      ...
      if (!SettingsManager().settings.enablePrivateAPI.value || !SettingsManager().settings.sendTypingIndicators.value) {
      ...
      if (controller.text.length == 0 && pickedImages.length == 0 && selfTyping) {
        ...
        selfTyping = true;
        if (SettingsManager().settings.sendTypingIndicators.value)
