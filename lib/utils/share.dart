      ...
      await showDialog(
          ...
          builder: (context) => AlertDialog(
            ...
            actions: [
              ...
              if (kIsDesktop && Platform.isLinux)
                TextButton(onPressed: () => Get.back(), child: Text("OK", style: context.theme.textTheme.bodyLarge!.copyWith(color: context.theme.colorScheme.primary))),
            ],
          )
      );
      if (!_serviceEnabled) {
            ...
            builder: (context) =>
                AlertDialog(
                  ...
                  actions: [
                    ...
                    TextButton(onPressed: () async => await Geolocator.openLocationSettings(),
