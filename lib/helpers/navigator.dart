...
class BaseNavigator extends GetxService {
  ...
  void push(BuildContext context, Widget widget) {
    if (Get.keys.containsKey(2) && (!context.isPhone || context.isLandscape) && (SettingsManager().settings.tabletMode.value || kIsDesktop)) {
  ...
  void pushLeft(BuildContext context, Widget widget) {
    if (Get.keys.containsKey(1) && (!context.isPhone || context.isLandscape) && (SettingsManager().settings.tabletMode.value || kIsDesktop)) {
  ...
  void pushSettings(BuildContext context, Widget widget, {Bindings? binding}) {
    if (Get.keys.containsKey(3) && (!context.isPhone || context.isLandscape) && (SettingsManager().settings.tabletMode.value || kIsDesktop)) {
