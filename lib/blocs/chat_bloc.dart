...
class ChatBloc {
  ...
  final StreamController<List<Chat>> _archivedChatController = StreamController<List<Chat>>.broadcast();
  ...
  int get pageSize {
    return (SettingsManager().settings.denseChatTiles || SettingsManager().settings.skin.value != Skins.iOS) ? 12 : 10;
  }
