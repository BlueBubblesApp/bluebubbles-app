...
class Message {
  ...
  String getLastUpdate() {
    final dates = [dateCreated, dateRead, dateDelivered, dateEdited, datePlayed].whereType<DateTime>();
    if (dates.isEmpty) return '';
    return dates.reduce((a, b) => a.isAfter(b) ? a : b).toIso8601String();
  }

  bool isNewerThan(Message other) {
    return (dateCreated ?? DateTime.fromMillisecondsSinceEpoch(0))
        .isAfter(other.dateCreated ?? DateTime.fromMillisecondsSinceEpoch(0));
  }
