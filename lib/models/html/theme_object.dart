...
class ThemeObject {
  ...
  List<ThemeEntry> toEntries() => [
        ThemeEntry.fromStyle(ThemeColors.Headline1, data!.textTheme.headlineLarge!),
        ThemeEntry.fromStyle(ThemeColors.Headline2, data!.textTheme.headlineMedium!),
  ...
  ThemeData get themeData {
    ...
    return ThemeData(
        textTheme: TextTheme(
          headlineLarge: data[ThemeColors.Headline1]!.style,
          headlineMedium: data[ThemeColors.Headline2]!.style,
        ...
        ).copyWith(surface: data[ThemeColors.BackgroundColor]!.style),
