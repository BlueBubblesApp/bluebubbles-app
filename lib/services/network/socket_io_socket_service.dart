...
class SocketIoSocketService extends GetxService implements SocketService {
  @override
  Rx<SocketState> state = SocketState.disconnected.obs;
  ...
  void startedTyping(String chatGuid) {
    sendMessage("started-typing", {"chatGuid": chatGuid});
  }
  
  @override
  void stoppedTyping(String chatGuid) {
    sendMessage("stopped-typing", {"chatGuid": chatGuid});
  }
  
  @override
  void updateTypingStatus(String chatGuid) {
    sendMessage("update-typing-status", {"chatGuid": chatGuid});
  }
