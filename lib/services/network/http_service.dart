...
import 'package:bluebubbles/services/network/native_adapter_io.dart'
    if (dart.library.html) 'package:bluebubbles/services/network/native_adapter_stub.dart'
    as native_adapter;
...
class HttpService extends GetxService {
  ...
  void onInit() {
    ...
    native_adapter.setNativeAdapter(dio);
