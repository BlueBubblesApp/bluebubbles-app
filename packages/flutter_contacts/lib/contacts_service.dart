...
class ContactsService {
  ...
  static Future<Contact> openContactForm(
      {bool iOSLocalizedLabels = true, String address, String addressType = 'phone'}) async {
    dynamic result = await _channel.invokeMethod('openContactForm',
        <String, dynamic>{'iOSLocalizedLabels': iOSLocalizedLabels, 'address': address, 'addressType': addressType});
