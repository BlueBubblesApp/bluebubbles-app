...
class PhotoViewControllerValue {
  ...
  @override
  String toString() {
    return 'PhotoViewControllerValue{position: $position, scale: $scale, rotation: $rotation, rotationFocusPoint: $rotationFocusPoint, boundaries: $boundaries}';
  }
}
...
class PhotoViewController
  ...
  @override
  ScaleBoundaries get boundaries => value.boundaries;

  @override
  set boundaries(ScaleBoundaries boundaries) {
    ...
    debugPrint("boundaries: ${boundaries.toString()}");
  }
  ...
  void updateMultiple({
    ...
    value = PhotoViewControllerValue(
      ...
      boundaries: boundaries ?? value.boundaries,
    );
  }
